...
<template>
  <div class="guest-page">
    ...
    <div class="guest-page__list">
      ...
      <div class="guest-page__item list-item" v-for="dish in dishes" :key="dish.id">
        <input class="guest-page__checkbox" type="checkbox" :value="dish" v-model="selectedDishes" />
    ...
    <div v-if="selectedDishes.length > 0" class="total-section">
      ...
      <div class="total-section__qr-wrapper">
        <img class="total-section__qr-code" alt="qrCode" :src="`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=Итого:${total}руб`"/>
      </div>
    </div>
  </div>
</template>
